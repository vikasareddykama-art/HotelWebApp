    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navMenu">
            <ul class="navbar-nav ms-auto gap-1">
                ...
                <li class="nav-item"><a class="nav-link active" href="UpdateReservation"><i class="fas fa-edit me-1"></i>Update</a></li>
...
<div class="page-header">
    <div class="container">
        <h1 class="page-title"><i class="fas fa-calendar-check me-2"></i>Update Reservation</h1>
        <p class="page-sub">Modify existing booking details</p>
    </div>
</div>
...
<div class="container">
    <div class="form-card">
        ...
        <div class="search-card">
            <p class="mb-2" style="color:rgba(255,255,255,0.6);font-size:0.85rem;">Enter Reservation ID to load details:</p>
            <form action="UpdateReservation" method="get" class="d-flex gap-2">
        ...
        <form action="UpdateReservation" method="post">
            ...
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" value="<%= r.getReservationID() %>" disabled>
                </div>
                <div class="col-12">
                    <label class="form-label">Customer Name <span class="text-warning">*</span></label>
                    <input type="text" class="form-control" name="customerName" value="<%= r.getCustomerName() %>" required maxlength="100">
                </div>
                <div class="col-12">
                    <label class="form-label">Room Number <span class="text-warning">*</span></label>
                    <input type="text" class="form-control" name="roomNumber" value="<%= r.getRoomNumber() %>" required maxlength="10">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12">
                    ...
                    <input type="number" class="form-control" name="totalAmount" value="<%= r.getTotalAmount() %>" step="0.01" required min="0">
                </div>
            </div>
